...
class HomeController extends GetxController {
  List items = [
    ...
    ['Feedback', "assets/images/child-feedback-icon.png",null],
    ['Classes', "assets/images/class-icon.png",null],
    ['Activities', "assets/images/activites-icon.png",()=>Get.to(()=>ActivitesPageView(),binding: ActivitesPageBinding())],
    ['Complaint', "assets/images/complaint-icon.png",()=>Get.to(()=>ComplaintsPageView(),binding: ComplaintsPageBinding())],
    ['Teacher', "assets/images/teacher-icon.png",()=>Get.to(()=>TeacherPageView(),binding: TeacherPageBinding())],
  ];
  final count = 0.obs;
  @override
  void onInit() {
